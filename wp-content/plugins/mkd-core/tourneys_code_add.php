...
{
    $content1 = '';
    $content1 .= '<select name="' .  "$name" . '" id="' .  "$name" . "_id" . '" ' . '>';
    $content1 .= '<option required value="" selected="selected">Choose ' . "$name" . '</option>';
    foreach ($r as $option) {
...
function getCategory() 
{
    ...
    $content3 .= '<select required name="' .  "category " . '" id="' .  "category" . '" ' . '>';
...
function getCategoryV2() 
{
    ...
    $content3 = '<select required name="' .  "category " . '" id="' .  "category_sch" . '" ' . '>';
    $content3 .= '<option value="" selected="selected">All</option>';
    foreach ($r as $category) {
...
function getCategoryTournament() 
{
    global $wpdb;
    global $content3;
    ...
    $content3 = '<select required name="' .  "category " . '" id="' .  "category_my_tour" . '" ' . '>';
    $content3 .= '<option value="" selected="selected">All</option>';
    foreach ($r as $category) {
