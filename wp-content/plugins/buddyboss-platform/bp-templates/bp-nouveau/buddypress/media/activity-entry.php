...
<div class="bb-activity-media-elem media-activity
	...
	>
		...
		<img src="<?php echo 1 === $media_template->media_count ? esc_url( bp_media_attachment_image_activity_thumbnail() ) : esc_url( bb_get_media_photos_directory_image_thumbnail() ); ?>" data-src="<?php echo 1 === $media_template->media_count ? esc_url( bp_media_attachment_image_activity_thumbnail() ) : esc_url( bb_get_media_photos_directory_image_thumbnail() ); ?>" class="no-round photo lazy" alt="<?php bp_media_title(); ?>" />
