			...
			<div class="modal-wrapper">
				<div class="modal-container has-folderlocationUI">
					...
					<footer class="bb-model-footer document-uploader-footer">
						...
						<label class="visib-label">Visiblity</label>
						<?php if ( ! bp_is_group() ) : ?>
...
document.addEventListener('click', function(e) {
    ...
    var target = e.target || e.srcElement,
		...
		if(target.className=='modal-mask bb-white bbm-model-wrap bbm-uploader-model-wrap'){
			
			var closeButton = document.getElementById("bp-media-uploader-close");
