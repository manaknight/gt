...
.choose-container .content-box .main-box.content-one .box .arrow-link.arrowlink-one {
  right: -40px;
  left: unset;
}
.choose-container .content-box .main-box.content-two .box .arrow-link.arrowlink-one {
  right: -40px;
  left: unset;
}
.choose-container .content-box .main-box.content-one .box .arrow-link.arrowlink-two {
  left: -40px;
  right: unset;
}
.choose-container .content-box .main-box.content-two .box .arrow-link.arrowlink-two {
  left: -40px;
  right: unset;
}
...
.popupLoader_before_pricing_display .lds-ring div{
    width: 100px;
    height: 100px;
    border: 12px solid #fff;
    z-index: 1;
    border-color: #784978 transparent transparent transparent;
}
.lds-ring {
...
<div class="popupLoader_before_pricing_display position_absolute" style="top: 200px; left: 40%; display: none;">
    <div class="lds-ring">
        <div></div>
        <div></div>
        <div></div>
...
<div class="container-fluid choose-container bg-light" id="tour_game">
  <div id="error-box" style="text-align: center;"></div>
  <input type="hidden" id="content-id" value="">
  <input type="hidden" id="round_number" value="1">
        <div class="choose-box px-2 py-4">
          <div class="heading mb-5">
            <h1 class="m-0 text-center contest-title" ></h1>
          </div>
          <div class="content-box flex-css" id="content-box">
            <!-- one -->
           <!--  <div
              class="main-box content-one flex-css-column mr-3"
              id="content-one"
            >
              <div class="title py-4 flex-css" style="display:none;">
                <h1>Content 1</h1>
              </div>
              ...
              <div class="btn-container flex-css py-4">
                <button class="btn-success choose-content" data-id="1">Choose</button>
              </div>
            </div> -->
            ...
            >
              ...
              <div class="btn-container flex-css py-4">
                <button class="btn-success choose-content" data-id="2">Choose</button>
              </div>
            </div> -->
          </div>
        </div>
        ...
        >
          <div class="alert-modal px-4 py-3">
            ...
            <div class="alert-content hidden" id="final-alert">
              <p class="text-center pt-4 round_number_started">Round 2 started</p>
